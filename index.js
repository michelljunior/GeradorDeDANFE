        ...
        if(error) {
            ...
            (async () => {
              ...
              const options = {
                ...
                footerTemplate: `
                  <div id="footer-template" style="font-size:10px !important; color:#808080; padding-left:50px">
                    Documento gerado as <span class="date"></span> por <a href="https://datasynchro.com.br">DataSynchro</a>
                  </div>`,
                margin: {
                  top: '30px',
                  bottom: '30px',
